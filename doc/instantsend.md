...
This mechanism has been integrated into Bitcore-Node-Stim which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stimcoin/insight-api-stim#web-socket-api](https://github.com/stimcoin/insight-api-stim#web-socket-api) 
* API: [https://github.com/stimcoin/insight-api-stim#instantsend-transactions](https://github.com/stimcoin/insight-api-stim#instantsend-transactions) 
...
By default, the Stim Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stim Core daemon:
