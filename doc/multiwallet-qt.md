...
Only requiring some minor changes is stim.cpp.
...
Changes to stim.cpp
----------------------
stim.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
