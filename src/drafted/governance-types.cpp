...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "StimNetwork") type = StimNetwork;
    if(strType == "StimNetworkVariable") type = StimNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == StimNetwork) s = "StimNetwork";
    if(type == StimNetworkVariable) s = "StimNetworkVariable";
