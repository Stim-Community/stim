 ...
 *
 *   // network
 *   CStimNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.stim.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CStimNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: StimNetwork
// //   -- signature requirements : Key1(User)
// class CStimNetworkVariable : public CGovernanceObject
// {
// private:
