...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case STM: return QString("STM");
            case mSTM: return QString("mSTM");
            case uSTM: return QString::fromUtf8("μSTM");
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case STM: return QString("Stim");
            case mSTM: return QString("Milli-Stim (1 / 1" THIN_SP_UTF8 "000)");
            case uSTM: return QString("Micro-Stim (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Stim (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case STM: return QString("TestStims");
