    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Stim Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Stim Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stim-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Stim in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 Stim, 0.1 Stim, 1 Stim and 10 Stim -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://stimcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://stimcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Stim Core is shutting down...") + "<br /><br />" +
