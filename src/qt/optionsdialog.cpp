    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Stim-light"), QVariant("light"));
    ui->theme->addItem(QString("Stim-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("Stim-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("Stim-traditional"), QVariant("trad"));
