    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Stim Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Stim address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stim: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Stim Core"), this);
    aboutAction->setStatusTip(tr("Show information about Stim Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Stim Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Stim addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Stim addresses"));
    ...
    openAction->setStatusTip(tr("Open a stim: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Stim Core help message to get a list with possible Stim Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Stim Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stim network", "", count));
}
...
{
    QString strTitle = tr("Stim Core"); // default title
